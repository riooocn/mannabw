    ...
    <div className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="w-full max-w-md border border-primary p-8 bg-surface-container">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider mb-2" htmlFor="name">
              Full Name
            </label>
            <input
              id="name"
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider mb-2" htmlFor="password_confirmation">
              Confirm Password
            </label>
            <input
